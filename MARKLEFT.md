...
[^comment-48217-a1b2] is a child comment footnote referenced from a comment footnote.
...
Child references inside a comment footnote define the display order of child comments and suggestions.
